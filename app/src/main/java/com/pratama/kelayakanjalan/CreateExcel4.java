...
public final class CreateExcel4 {
    ...
    private Label label;
    private String sistemJaringan = null, status = null, fungsi = null,
            kelasPrasarana = null, kelasPenggunaan = null, medan = null;
    ...
    @RequiresApi(api = Build.VERSION_CODES.O)
    public CreateExcel4(String idsegmen, String filepath, String nru, String seg, TextView progres, NumberProgressBar percen) throws IOException, BiffException, WriteException {
        ...
        try{
            ...
            KoneksiDB3 koneksi = new KoneksiDB3();
    ...
    public void insertIdentitasRuas(String idSegmen) throws WriteException, IOException {
        ...
        int[] nomorBaris = {2, 3, 3, 4, 4, 5, 5, 6, 14};
        ...
        //Set header
        String header = "HASIL SURVEY DAN ANALISIS ULFJ RUAS " + dataRuas[1] + " PADA SEGMEN " + dataRuas[5];
        sheet.getSettings().setHeader(new jxl.HeaderFooter(header));
    }
    ...
    public void insertDataA111(String idSegmen) throws WriteException, MalformedURLException, IOException {
        ...
        if (data[0] != null) {
            ...
            if (!data[3].toString().substring(0, 1).equals("-")) {
                number = new Number(9, 34, Double.parseDouble(data[3].toString()) / 100, PercentCellFormat);    //hasil uji
                sheet.addCell(number);
                number = new Number(10, 34, Double.parseDouble(data[4].toString()) / 100, PercentCellFormat);   //deviasi
                sheet.addCell(number);
            }
                    ...
                    try {
                        ...
                        if(fileLength > 102400){
                            ...
                            try {
                                ...
                                bitmap.compress(Bitmap.CompressFormat.WEBP, 100, save);
                                save.flush();
                                img.close();
                                save.close();
                            ...
                            WritableImage image = new WritableImage(
                                    ...
                                    new File(mediaStorageDir.getAbsolutePath()));           //file image
        ...
        if (data[0] != null) {
            ...
            if (kelasPrasarana.toUpperCase().equals("JALAN BEBAS HAMBATAN (JBH)")) {
                if (!data[8].toString().substring(0, 1).equals("-")) {
                    ...
                    //fill color pada cell
                    WritableCell cell = sheet.getWritableCell(7, 60);
                    cell.setCellFormat(bgColorCenter);
                }
            } else {
                if (!data[8].toString().substring(0, 1).equals("-")) {
                    ...
                    //fill color pada cell
                    WritableCell cell = sheet.getWritableCell(7, 61);
                    cell.setCellFormat(bgColorCenter);
                }
            }
    ...
    public void insertDataA113(String idSegmen) throws WriteException, MalformedURLException, IOException {
        ...
        if (data[0] != null) {
            ...
            if (!data[11].toString().substring(0, 1).equals("-")) {
                ...
                sheet.addCell(label);
                number = new Number(10, (nomorBaris + 1), Double.parseDouble(data[12].toString()) / 100, PercentCellFormat);   //deviasi
                sheet.addCell(number);
        ...
        if (data[0] != null) {
            ...
            if (medan.toUpperCase().equals("DATAR (D)")) {
                if (!data[0].toString().substring(0, 1).equals("-")) {
                    ...
                    //fill color pada cell
                    WritableCell cell = sheet.getWritableCell(5, 446);
                    cell.setCellFormat(bgColorCenter);
                }
                ...
                if (!data[2].toString().substring(0, 1).equals("-")) {
                    ...
                    //fill color pada cell
                    WritableCell cell = sheet.getWritableCell(5, 447);
                    cell.setCellFormat(bgColorCenter);
                }
        ...
        if (data[0] != null) {
            ...
            if (fungsi.toUpperCase().equals("ARTERI")) {
                if (!data[8].toString().substring(0, 1).equals("-")) {
                    ...
                    //fill color pada cell
                    WritableCell cell = sheet.getWritableCell(nomorKolom, 528);
                    cell.setCellFormat(bgColorCenter);
                }
            } else if (fungsi.toUpperCase().equals("KOLEKTOR")) {
                if (!data[8].toString().substring(0, 1).equals("-")) {
                    ...
                    //fill color pada cell
                    WritableCell cell = sheet.getWritableCell(nomorKolom, 529);
                    cell.setCellFormat(bgColorCenter);
                }
